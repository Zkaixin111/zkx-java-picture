    ...
    yAxis: [
      {
        type: 'value',
        name: '图片数量',
        axisLine: { show: true, lineStyle: { color: 'var(--dt-color-chart-1)' } }, // 修改理由：规则8 — 令牌化图表色
      },
      {
        type: 'value',
        name: '图片总大小 (MB)',
        position: 'right',
        axisLine: { show: true, lineStyle: { color: 'var(--dt-color-chart-2)' } }, // 修改理由：规则8 — 令牌化图表色
        splitLine: {
          lineStyle: {
            color: 'var(--dt-color-chart-2)', // 网格线颜色 — 修改理由：规则8 — 令牌化
